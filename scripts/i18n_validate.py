...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate I18N translations and protected tokens.")
    ...
    for key, entry in data.get("entries", {}).items():
        ...
        for locale in locales:
            ...
            actual = tokens(value)
            if actual != expected:
                errors.append(f"{key}/{locale}: protected tokens differ: {expected} != {actual}")

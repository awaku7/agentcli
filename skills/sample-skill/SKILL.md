...
This is a minimal Agent Skills example.

## Steps

1. Use `skills_validate` to validate this skill.
1. Use `skills_load` to load full instructions.
1. Use `skills_read_file` to load referenced files.

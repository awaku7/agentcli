...
class build_py(_build_py):
    ...
    def run(self):
        ...
        if src_readme_ja.exists():
            ...
            dst_readme_ja.write_text(
                src_readme_ja.read_text(encoding="utf-8"), encoding="utf-8"
            )

        if src_quickstart_ja.exists():
            dst_quickstart_ja.parent.mkdir(parents=True, exist_ok=True)
            dst_quickstart_ja.write_text(
                src_quickstart_ja.read_text(encoding="utf-8"), encoding="utf-8"
            )

...
## Detailed Japanese developer notes

The former `DEVELOP.ja.md` content is retained below. The English sections above remain the primary developer reference; this section preserves the Japanese notes and examples.

...
## Detailed usage and artifact reference (Japanese)

The former `WEBINSPECTER.ja.md` content is retained below. The concise reference above remains the primary entry point.

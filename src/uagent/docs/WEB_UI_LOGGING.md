...
The former `WEB_UI_LOGGING.ja.md` content is retained below. The English section above is the short reference; this section preserves the detailed implementation notes and message-path behavior.

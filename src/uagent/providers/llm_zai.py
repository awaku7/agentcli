...
def _get_valid_zai_efforts(model_name: str = "") -> frozenset:
    """Return valid reasoning_effort values for a Z.AI model.
...
def build_zai_chat_kwargs(
    *,
    ...
    valid_efforts = _get_valid_zai_efforts(depname)
    ...
    try:
        ...
        apply_shared_max_tokens(chat_kwargs, model_id=depname, provider="zai")
    except Exception:
        pass
    ...
    while True:
        try:
            ...
            if output_format is not None:
                ...
                # communicated in the system prompt, not as json_schema.

...
def publish(client: Any, topic: str, payload: str, qos: int = 0, retain: bool = False) -> dict[str, Any]:
...
def subscribe(client: Any, topic: str, qos: int = 0,
              callback: Callable[[str, str], None] | None = None) -> dict[str, Any]:
    """Subscribe to an MQTT topic."""
    if callback:
        client.message_callback_add(topic, lambda cl, ud, msg: callback(msg.topic, msg.payload.decode("utf-8")))

...
TOOL_SPEC: dict[str, Any] = {
    ...
    "function": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "operation": {"type": "string", "enum": ["interfaces", "connections", "correlate"], "default": "interfaces"},
                "findings": {"type": "array", "description": "Metadata-only pcap findings to correlate with current local connections."},
                "status": {"type": "string", "description": "Optional connection status filter, for example ESTABLISHED."},
                "local_ip": {"type": "string", "description": "Optional local IP filter."},
                "remote_ip": {"type": "string", "description": "Optional remote IP filter."},
                "port": {"type": "integer", "minimum": 0, "description": "Optional local or remote port filter."},
                "include_process": {"type": "boolean", "default": True, "description": "Include PID and process name when permitted."},
            },
        },
    },
}

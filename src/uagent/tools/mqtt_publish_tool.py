        ...
        "parameters": {
            ...
            "properties": {
                ...
                "topic": {
                    "type": "string",
                    "description": _(
                        "param.topic.description", default="MQTT topic to publish to."
                    ),
                },
                "payload": {
                    "type": "string",
                    "description": _(
                        "param.payload.description", default="Message payload."
                    ),
                },
                "qos": {
                    "type": "integer",
                ...
                "retain": {
                    ...
                    "default": False,
                    "description": _(
                        "param.retain.description", default="Retain message on broker."
                    ),
                },
                "username": {
                    "type": "string",
...
def _format_text(payload: dict[str, Any]) -> str:
    ...
    return _(
        "msg.sent",
        default="MQTT published: {topic} = {payload} [{qos}]",
...
def run_tool(args: dict[str, Any]) -> str:
    ...
    if not host or not topic or not payload:
        return json.dumps(
            {"ok": False, "error": "host, topic, payload are required."},
            ensure_ascii=False,
        )

...
_EOJ_CLASS_NAMES: dict[int, tuple[str, str]] = {
    0x0002: ("Crime prevention sensor", "Crime prevention sensor"),
    0x0003: ("Emergency button", "Emergency button"),
    0x0007: ("Human detection sensor", "Human detection sensor"),
    0x0011: ("Temperature sensor", "Temperature sensor"),
    0x0012: ("Humidity sensor", "Humidity sensor"),
    0x0016: ("Bath heating status sensor", "Bath heating status sensor"),
    0x001B: ("CO2 sensor", "CO2 sensor"),
    0x001D: ("VOC sensor", "VOC sensor"),
    0x0022: ("Electric energy sensor", "Electric energy sensor"),
    0x0023: ("Current sensor", "Current sensor"),
    0x00D0: ("Illuminance sensor", "Illuminance sensor"),
    0x0130: ("Home air conditioner", "Home air conditioner"),
    0x0133: ("Ventilation fan", "Ventilation fan"),
    0x0134: ("Air conditioner ventilation fan", "Air conditioner ventilation fan"),
    0x0135: ("Air cleaner", "Air cleaner"),
    0x0156: ("Commercial AC indoor unit", "Commercial AC indoor unit"),
    0x0157: ("Commercial AC outdoor unit", "Commercial AC outdoor unit"),
    0x0260: ("Electrically operated blind/shade", "Electrically operated blind/shade"),
    0x0263: ("Electrically operated shutter", "Electrically operated shutter"),
    0x026B: ("Electric water heater", "Electric water heater"),
    0x026F: ("Electric lock", "Electric lock"),
    0x0272: ("Instantaneous water heater", "Instantaneous water heater"),
    0x0273: ("Bathroom heater dryer", "Bathroom heater dryer"),
    0x0279: ("Household solar power generation", "Household solar power generation"),
    0x027A: ("Cold/hot water heat source", "Cold/hot water heat source"),
    0x027B: ("Floor heater", "Floor heater"),
    0x027C: ("Fuel cell", "Fuel cell"),
    0x027D: ("Storage battery", "Storage battery"),
    0x027E: ("EV charger/discharger", "EV charger/discharger"),
    0x0280: ("Watt-hour meter", "Watt-hour meter"),
    0x0281: ("Water flowmeter", "Water flowmeter"),
    0x0282: ("Gas meter", "Gas meter"),
    0x0287: ("Power distribution meter", "Power distribution meter"),
    0x0288: ("Low-voltage smart meter", "Low-voltage smart meter"),
    0x028A: ("High-voltage smart meter", "High-voltage smart meter"),
    0x028D: ("Smart sub-meter", "Smart sub-meter"),
    0x028E: ("Distributed generator meter", "Distributed generator meter"),
    0x028F: ("Bidirectional HV smart meter", "Bidirectional HV smart meter"),
    0x0290: ("General lighting", "General lighting"),
    0x0291: ("Mono functional lighting", "Mono functional lighting"),
    0x02A1: ("EV Charger", "EV Charger"),
    0x02A3: ("Lighting system", "Lighting system"),
    0x02A4: ("Extended lighting system", "Extended lighting system"),
    0x02A5: ("Multiple input PCS", "Multiple input PCS"),
    0x02A6: ("Hybrid water heater", "Hybrid water heater"),
    0x02A7: ("Frequency regulation", "Frequency regulation"),
    0x03B7: ("Refrigerator", "Refrigerator"),
    0x03B9: ("Cooking heater", "Cooking heater"),
    0x03BB: ("Rice cooker", "Rice cooker"),
    0x03CE: ("Commercial showcase", "Commercial showcase"),
    0x03D3: ("Washer/dryer", "Washer/dryer"),
    0x03D4: ("Commercial showcase outdoor unit", "Commercial showcase outdoor unit"),
    0x05FD: ("Switch (JEM-A/HA)", "Switch (JEM-A/HA)"),
    0x05FF: ("Controller", "Controller"),
    0x0602: ("Television", "Television"),
}

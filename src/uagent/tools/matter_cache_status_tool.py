...
TOOL_SPEC: dict[str, Any] = {
    ...
    "function": {
        ...
        "description": _(
            ...
            "x_search_terms": _(            "x_search_terms",            default=["matter cache status", "matter_cache_status", "matter", "MATTER", "statistics", "ratio", "entry", "count"],        ),        "x_search_terms_en": ["matter cache status", "matter_cache_status", "matter", "MATTER", "statistics", "ratio", "entry", "count"],
        "parameters": {
            "type": "object",
            "properties": {},

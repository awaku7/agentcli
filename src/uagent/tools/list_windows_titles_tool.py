...
TOOL_SPEC: dict[str, Any] = {
    ...
    "function": {
        ...
        "description": _(
            "tool.description",
            default="Enumerate top-level window titles on Windows and return structured JSON. Parameters: 'all' (include non-visible), 'pid' (include PID), 'class' (include class name).",
        ),
        "x_search_terms": _(
            "x_search_terms",
            default=[

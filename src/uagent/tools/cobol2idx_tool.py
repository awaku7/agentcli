...
_PATTERNS = [
    ...
    # DATA DIVISION
    (r"DATA\s+DIVISION", lambda m: ("division", "DATA DIVISION")),
    # PROCEDURE DIVISION [USING ...]
    (r"PROCEDURE\s+DIVISION", lambda m: ("division", "PROCEDURE DIVISION")),
    # ENVIRONMENT DIVISION
    (r"ENVIRONMENT\s+DIVISION", lambda m: ("division", "ENVIRONMENT DIVISION")),
    # CONFIGURATION SECTION
    (r"CONFIGURATION\s+SECTION\.?\s*$", lambda m: ("section", "CONFIGURATION SECTION")),
    # INPUT-OUTPUT SECTION
    (r"INPUT-OUTPUT\s+SECTION\.?\s*$", lambda m: ("section", "INPUT-OUTPUT SECTION")),
    ...
    # LINKAGE SECTION
    (r"LINKAGE\s+SECTION\.?\s*$", lambda m: ("section", "LINKAGE SECTION")),
    # FILE SECTION
    (r"FILE\s+SECTION\.?\s*$", lambda m: ("section", "FILE SECTION")),
    # SCREEN SECTION
    ...
    # DECLARATIVES.
    (r"^DECLARATIVES\.?\s*$", lambda m: ("declaratives", "DECLARATIVES")),
    # END DECLARATIVES.
    (r"^END\s+DECLARATIVES\.?\s*$", lambda m: ("end-declaratives", "END DECLARATIVES")),

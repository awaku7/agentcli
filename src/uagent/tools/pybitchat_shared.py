...
# ---- Noise XX implementation lives in bitchat_noise.py ----------------------
# Keep the transport module as the single source of truth. The old duplicate
# state machine was removed because it used a different protocol initialization
# and omitted the empty-payload authentication tags required by Noise XX.

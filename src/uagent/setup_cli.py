...
HEADER_ENV = "\n".join(
    [
        _("# .env for uag (generated by `uag_setup`)"),
        _("#"),
        _("# Notes:"),
        _("# - This file may contain secrets (API keys). Do NOT commit it to Git."),
        _("# - You can re-run `uag_setup` anytime to regenerate."),
    ]
).rstrip("\n")
...
HEADER_SH = "\n".join(
    [
        _("#!/usr/bin/env bash"),
        _("# Auto-generated by uag_setup"),
        _("# Do not edit this file directly. Re-run uag_setup to regenerate."),
    ]
).rstrip("\n")
...
HEADER_BAT = "\n".join(
    [
        _("@echo off"),
        _("REM Auto-generated by uag_setup"),
        _("REM Do not edit this file directly. Re-run uag_setup to regenerate."),
    ]
).rstrip("\n")
...
def _env_lines_from_state(st: _WizardState) -> list[str]:
    ...
    for prov, label in PROVIDERS:
        section(
            _("%(label)s (UAGENT_PROVIDER=%(prov)s)") % {"label": label, "prov": prov}
        )
    ...
    if st.provider in RESPONSES_PROVIDERS:
        ...
        out.append(_("# (not supported by selected provider)"))
    out.append("")
        ...
        if stage == 2:
            if st.provider in RESPONSES_PROVIDERS:
                ...
                if st.responses_enabled:
                    r = _menu_choice(
                        _("Select reasoning"),
                        [_("minimal"), _("low"), _("medium"), _("high"), _("auto")],
                        default_index=3,
                        allow_back=True,
                    )
                    if r == "__quit__":
                    ...
                    if v == "__back__":
                        continue
                    st.verbosity = [_("low"), _("medium"), _("high")][int(v) - 1]
            else:

...
1. [Estrutura básica da ferramenta](#1-estrutura-b%C3%A1sica-da-ferramenta)

1. [Criando uma ferramenta Python](#2-creating-a-python-tool)

1. [Criando uma ferramenta Rust + Python](#3-creating-a-rust--python-tool)

1. [Referência TOOL_SPEC](#4-tool_spec-reference)

1. [Internacionalização (i18n)](#5-internacionaliza%C3%A7%C3%A3o-i18n)

1. [Teste e depuração](#6-teste-e-depura%C3%A7%C3%A3o)

1. [Exemplos de referência](#7-exemplos-de-refer%C3%AAncia)

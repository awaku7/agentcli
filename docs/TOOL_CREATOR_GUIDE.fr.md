...
1. [Création d'un outil Python](#2-creating-a-python-tool)

1. [Création d'un outil Rust + Python](#3-creating-a-rust--python-tool)

1. [Référence TOOL_SPEC](#4-tool_spec-reference)

1. [Internationalisation (i18n)](#5-internationalization-i18n)

1. [Test et débogage](#6-test-et-d%C3%A9bogage)

1. [Exemples de référence](#7-reference-examples)

...
1. [Membuat Alat Python](#2-membuat-alat-python)

1. [Membuat Alat Rust + Python](#3-membuat-a-rust--python-tool)

1. [Referensi TOOL_SPEC](#4-referensi-tool_spec)

1. [Internasionalisasi (i18n)](#5-internasionalisasi-i18n)

1. [Pengujian dan Debug](#6-pengujian-dan-debugging)

1. [Contoh Referensi](#7-contoh-referensi)

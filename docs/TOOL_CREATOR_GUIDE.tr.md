...
1. [Temel Araç Yapısı](#1-temel-ara%C3%A7-yap%C4%B1s%C4%B1)

1. [Python Aracı Oluşturma](#2-bir-python-arac%C4%B1-olu%C5%9Fturma)

1. [Bir Rust + Python Aracı Oluşturma](#3-pas-yaratma--python-arac%C4%B1)

1. [TOOL_SPEC Referansı](#4-tool_spec-reference)

1. [Uluslararasılaştırma (i18n)](#5-uluslararas%C4%B1la%C5%9Ft%C4%B1rma-i18n)

1. [Test Etme ve Hata Ayıklama](#6-test-etme-ve-hata-ay%C4%B1klama)

1. [Referans Örnekleri](#7-reference-examples)

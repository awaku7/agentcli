...
1. [Een Python-tool maken](#2-creating-a-python-tool)

1. [Een Rust- en Python-tool maken](#3-creating-a-rust--python-tool)

1. [TOOL_SPEC-referentie](#4-tool_spec-reference)

1. [Internationalisering (i18n)](#5-internationalisering-i18n)

1. [Testen en foutopsporing](#6-testing-and-debugging)

1. [Referentievoorbeelden](#7-reference-examples)

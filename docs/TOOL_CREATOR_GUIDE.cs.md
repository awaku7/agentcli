...
1. [Základní struktura nástroje](#1-z%C3%A1kladn%C3%AD-struktura-n%C3%A1stroje)

1. [Vytvoření nástroje Python](#2-creating-a-python-tool)

1. [Vytvoření nástroje Rust + Python](#3-creating-a-rust--python-tool)

1. [TOOL_SPEC Reference](#4-tool_spec-reference)

1. [Internacionalizace (i18n)](#5-internacionalizace-i18n)

1. [Testování a ladění](#6-testov%C3%A1n%C3%AD-a-lad%C4%9Bn%C3%AD)

1. [Referenční příklady](#7-reference-examples)

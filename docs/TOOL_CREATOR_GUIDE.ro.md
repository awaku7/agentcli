...
1. [Structură de bază a instrumentului](#1-structur%C4%83-de-baz%C4%83-instrument)

1. [Crearea unui instrument Python](#2-crearea-un-instrument-python)

1. [Crearea unui instrument Rust + Python](#3-crearea-o-rugin%C4%83--python-tool)

1. [TOOL_SPEC Reference](#4-tool_spec-reference)

1. [Internaționalizare (i18n)](#5-interna%C8%9Bionalizare-i18n)

1. [Testare și depanare](#6-testare-%C8%99i-depanare)

1. [Exemple de referință](#7-exemple-de-referin%C8%9B%C4%83)

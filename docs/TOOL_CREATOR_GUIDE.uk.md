...
1. [Створення інструменту Python](#2-creating-a-python-tool)

1. [Створення інструменту Rust + Python](#3-creating-a-rust--python-tool)

1. [Довідка щодо TOOL_SPEC](#4-tool_spec-reference)

1. [Інтернаціоналізація (i18n)](#5-internationalization-i18n)

1. [Тестування та налагодження](#6-testing-and-debugging)

1. [Довідкові приклади](#7-reference-examples)

...
uag は、**ベンダーロックされたアプリから自由でいられるように**作られています。作業に合うインターフェースを使い、プロバイダを切り替え、環境を自分で管理できます。

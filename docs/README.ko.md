...
<p align="center">
  ...
  ·
  <a href="README.translations.md">귀하의 언어로 읽어보세요</a>
</p>
...
모든 환경 변수는 [ENVIRONMENT.md](../ENVIRONMENT.md))를 참조하세요.
...
전환하려면 'UAGENT_LANG'을 설정하세요. 새 로케일을 추가하려면 [ADD_LOCALE.md](../src/uagent/docs/ADD_LOCALE.md))를 참조하세요.
...
- **환경 변수**: [ENVIRONMENT.md](../ENVIRONMENT.md))

...
<p align="center">
  ...
  ·
  <a href="README.translations.md">हे तुमच्या भाषेत वाचा</a>
</p>
...
सर्व पर्यावरणीय चलांसाठी [ENVIRONMENT.md](../ENVIRONMENT.md)) पहा.
...
स्विच करण्यासाठी `UAGENT_LANG` सेट करा. नवीन लोकॅल जोडण्यासाठी [ADD_LOCALE.md](../src/uagent/docs/ADD_LOCALE.md)) पहा.
...
- **पर्यावरण व्हेरिएबल्स**: [ENVIRONMENT.md](../ENVIRONMENT.md))

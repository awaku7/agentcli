...
- **222 साधने**: फाइल I/O, वेब शोध, प्रतिमा निर्मिती, Gmail, BLE डिव्हाइस स्कॅनिंग, MCP सर्व्हर एकत्रीकरण — **130 समांतर-सुरक्षित आहेत** (थ्रेड पूलद्वारे एकावेळी 8 पर्यंत चालतात; `UAGENT_PARALLEL_WORKERS` ने कॉन्फिगर करता येतात). जेव्हा LLM एकाच वेळी अनेक टूल कॉल फायर करते, uag स्वयंचलितपणे त्यांना समांतर करते.

...
- **222 værktøjer** til filhåndtering, websøgning, billeder, lyd, dokumenter, IoT, MCP, A2A og udvikling.
...
- **130 værktøjer** er markeret som `x_parallel_safe` og kan køres parallelt.

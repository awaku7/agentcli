...
| `UAGENT_CONSECUTIVE_TOOL_CALL_LIMIT` | Maximalt antal på varandra följande nya verktygsanrop (standard: `50`) |
| `UAGENT_MAX_TOOL_ROUNDS` | Maximalt antal LLM/verktygsrundor per användaroperation (standard: `128`) |

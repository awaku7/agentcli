...
- **BACnet**: BACnet/IP ডিভাইস পড়ুন/লিখুন (HVAC, আলো, পাওয়ার মিটার)। পুশ নোটিফিকেশনের জন্য COV সাবস্ক্রিপশন
- **Modbus TCP**: হোল্ডিং/ইনপুট রেজিস্টার এবং কয়েল পড়ুন/লিখুন। পোলিং-ভিত্তিক পরিবর্তন পর্যবেক্ষণ
- **OPC UA**: ঠিকানার স্থান ব্রাউজ করুন, ভেরিয়েবলগুলি পড়ুন/লিখুন, ডেটা পরিবর্তনগুলিতে সদস্যতা নিন
- **SwitchBot**: ক্লাউড ব্যাচ নিয়ন্ত্রণ এবং BLE স্ক্যান/নিয়ন্ত্রণ। পোলিং-ভিত্তিক সাবস্ক্রিপশন
- **ECHONET Lite**: হোম অ্যাপ্লায়েন্স (AC, লাইট, ওয়াটার হিটার, ইত্যাদি) থেকে INF বিজ্ঞপ্তিগুলি আবিষ্কার করুন, নিয়ন্ত্রণ করুন এবং সদস্যতা নিন
- **ব্যাপার**: পড়া/লেখা নিয়ন্ত্রণ + রাষ্ট্র পরিবর্তন পর্যবেক্ষণের জন্য অ্যাট্রিবিউট সাবস্ক্রিপশন
- **UPnP** 
- **UPnP** 
 ডিস্কভারিং 

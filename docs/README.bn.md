...
- **171 টুল**: ফাইল I/O, ওয়েব সার্চ, ইমেজ জেনারেশন, Gmail, BLE ডিভাইস স্ক্যানিং, MCP সার্ভার ইন্টিগ্রেশন — **87 সমান্তরাল-নিরাপদ** (8 পর্যন্ত থ্রেড পুলের মাধ্যমে একযোগে কার্যকর করা যায়, `UAGENT_PARALLEL_WORKERS` এর মাধ্যমে কনফিগার করা যায়)। যখন LLM একাধিক টুল কল একবারে ফায়ার করে, uag স্বয়ংক্রিয়ভাবে তাদের সমান্তরাল করে।

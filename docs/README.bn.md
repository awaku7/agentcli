...
128টি টুলগুলিকে `x_parallel_safe` চিহ্নিত করা হয়েছে এবং একটি `ThreadPoolExecutor` এর মাধ্যমে একযোগে চালান (ডিফল্টভাবে ৮টি থ্রেড; পরিবর্তন করতে `UAGENT_PARALLEL_WORKERS` সেট করুন)।

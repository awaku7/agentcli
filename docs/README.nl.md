...
- **Ondersteuning voor meerdere providers**: OpenAI / Azure / Bedrock / OpenRouter / Ollama / Gemini / Vertex AI / Claude / Grok / NVIDIA / DeepSeek / Alibaba Cloud (Qwen) / Moonshot AI / MiMo / LM Studio.
- **Drie interfaces**:
...
- **Gereedschapscatalogus (Nieuw!)**: Ontdek en laad gereedschappen dynamisch met `tool_catalog`/`tool_load`. Werkt met alle ondersteunde aanbieders — geen aanbiederspecifieke API’s nodig.

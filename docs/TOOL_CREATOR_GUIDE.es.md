...
1. [Estructura de herramienta básica](#1-estructura-de-herramienta-b%C3%A1sica)

1. [Creando una herramienta Python](#2-creando-una-herramienta-python)

1. [Creando una herramienta Rust + Python](#3-creando-una-herramienta-rust--python)

1. [Referencia TOOL_SPEC](#4-tool_spec-reference)

1. [Internacionalización (i18n)](#5-internacionalizaci%C3%B3n-i18n)

1. [Prueba y depuración](#6-prueba-y-depuraci%C3%B3n)

1. [Ejemplos de referencia](#7-ejemplos-de-referencia)

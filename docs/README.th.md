...
- **เครื่องมือ 135 รายการ**: ไฟล์ I/O, การค้นหาเว็บ, การสร้างภาพ, Gmail, การสแกนอุปกรณ์ BLE, การบูรณาการเซิร์ฟเวอร์ MCP — **78 รายการเป็นแบบปลอดภัยแบบขนาน** (สูงสุด 8 รายการดำเนินการพร้อมกันผ่านกลุ่มเธรด กำหนดค่าได้ผ่าน `UAGENT_PARALLEL_WORKERS`) เมื่อ LLM เรียกใช้เครื่องมือหลายรายการพร้อมกัน uag จะขนานการเรียกเครื่องมือเหล่านั้นโดยอัตโนมัติ
...
เครื่องมือ 78 รายการถูกทำเครื่องหมายเป็น `x_parallel_safe` และดำเนินการพร้อมกันผ่าน `ThreadPoolExecutor` (8 เธรดตามค่าเริ่มต้น ตั้งค่า `UAGENT_PARALLEL_WORKERS` เพื่อเปลี่ยนแปลง)

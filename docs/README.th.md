...
- **เครื่องมือ 131 รายการ**: ไฟล์ I/O, การค้นหาเว็บ, การสร้างภาพ, การสแกนอุปกรณ์ BLE, การรวมเซิร์ฟเวอร์ MCP — และ **76 เครื่องมือพร้อมทำงานแบบขนาน** (สูงสุด 4 รายการพร้อมกัน) เมื่อ LLM เรียกใช้เครื่องมือหลายรายการพร้อมกัน uag จะเรียกใช้งานโดยอัตโนมัติผ่านเธรดพูล
- **4 UI + A2A**: CLI, GUI, เว็บ และโปรโตคอล Agent-to-Agent เครื่องยนต์เดียวกัน อินเทอร์เฟซใดก็ได้
...
เครื่องมือ 76 รายการถูกทำเครื่องหมาย `x_parallel_safe` และดำเนินการพร้อมกันผ่าน `ThreadPoolExecutor` แบบ 4 เธรด
...
| **เครื่องมือสำหรับการพัฒนา** | git_ops, python_compile, lint_format, run_tests, db_query, **13 idx tools** |

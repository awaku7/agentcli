...
1. [Podstawowa struktura narzędzia](#1-podstawowa-struktura-narz%C4%99dzia)

1. [Tworzenie narzędzia Python](#2-creating-a-python-tool)

1. [Tworzenie narzędzia Rust + Python](#3-creating-a-rust--python-tool)

1. [Odniesienie do TOOL_SPEC](#4-odniesienie-do-specyfikacji-narz%C4%99dzia)

1. [Internacjonalizacja (i18n)](#5-internacjonalizacja-i18n)

1. [Testowanie i debugowanie](#6-testowanie-i-debugowanie)

1. [Przykłady referencyjne](#7-przyk%C5%82ady-referencyjne)

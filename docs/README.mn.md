...
- **136 хэрэгсэл**: Файл оруулах/гаралт, вэб хайлт, зураг үүсгэх, Gmail, BLE төхөөрөмж скан хийх, MCP серверийг нэгтгэх — **78 нь зэрэгцээ аюулгүй** (8 хүртэлх нь урсгалын сангаар нэгэн зэрэг ажиллах, `UAGENT_PARALLEL_WORKERS`-ээр тохируулах боломжтой). LLM нь хэд хэдэн хэрэгслийн дуудлагыг нэгэн зэрэг хийх үед uag автоматаар тэдгээрийг параллель болгодог.
...
78 хэрэгслийг `x_parallel_safe` гэж тэмдэглэсэн бөгөөд `ThreadPoolExecutor`-аар нэгэн зэрэг гүйцэтгэнэ (анхдагчаар 8 урсгал; өөрчлөхийн тулд `UAGENT_PARALLEL_WORKERS`-г тохируулна уу).
...
- **BACnet**: BACnet/IP төхөөрөмжүүдийг (HVAC, гэрэлтүүлэг, цахилгаан тоолуур) унших/бичих. Түлхэх мэдэгдлийн COV захиалга
- **Modbus TCP**: Унших/бичих барих/оролтын бүртгэл болон ороомог. Санал асуулгад суурилсан өөрчлөлтийн хяналт
- **OPC UA**: Хаягийн зайг үзэх, хувьсагч унших/бичих, өгөгдлийн өөрчлөлтөд бүртгүүлэх
- **SwitchBot**: Үүлэн багцын хяналт ба BLE скан/хяналт. Санал асуулгад суурилсан захиалга
- **ECHONET Lite**: Гэр ахуйн цахилгаан хэрэгсэл (AC, гэрэл, ус халаагч гэх мэт)-аас INF мэдэгдлүүдийг олж илрүүлэх, хянах, бүртгүүлэх
- **Асуудал**: Унших/бичих хяналт + төлөвийн өөрчлөлтийг хянах шинж чанарын захиалга
- **UPnP**=Төхөөрөмжийг илрүүлэх портыг харах[BR=] [IOT_USECASE.md](../IOT_USECASE.md)

...
<p align="center">
  ...
  ·
  <a href="README.translations.md">Үүнийг өөрийн хэлээр уншина уу</a>
</p>
...
- **131 хэрэгсэл**: Файл оруулах/гаралт, вэб хайлт, зураг үүсгэх, BLE төхөөрөмж скан хийх, MCP серверийг нэгтгэх — ба **76 нь зэрэгцээ ажилладаг**. LLM нь олон хэрэгслийн дуудлагыг нэгэн зэрэг хийх үед uag нь урсгалын сангаар дамжуулан автоматаар гүйцэтгэдэг.
- **4 UI + A2A**: CLI, GUI, Вэб, Агентаас Агент руу протокол. Ижил хөдөлгүүр, ямар ч интерфейс.
...
Орчны бүх хувьсагчийг [ENVIRONMENT.md](../ENVIRONMENT.md)) харна уу.
...
76 хэрэгслийг `x_parallel_safe` гэж тэмдэглэсэн бөгөөд 4 урсгалтай `ThreadPoolExecutor`-аар нэгэн зэрэг гүйцэтгэнэ.
...
| **Dev Tools** | git_ops, python_compile, lint_format, run_tests, db_query, **13 idx tools** |
...
Сэлхийн тулд `UAGENT_LANG`-г тохируулна уу. Шинэ хэл нэмэхийн тулд [ADD_LOCALE.md](../src/uagent/docs/ADD_LOCALE.md))-г үзнэ үү.
...
- **Орчны хувьсагчид**: [ENVIRONMENT.md](../ENVIRONMENT.md))

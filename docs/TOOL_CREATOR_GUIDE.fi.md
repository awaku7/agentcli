...
1. [Python-työkalun luominen](#2-creating-a-python-tool)

1. [Creating a Rust + Python Tool](#3-creating-a-rust--python-tool)

1. [TOOL_SPEC Reference](#4-tool_spec-reference)

1. [Kansainvälistyminen (i18n)](#5-internationalization-i18n)

1. [Testaus ja virheenkorjaus](#6-testing-and-debugging)

1. [Viiteesimerkit](#7-reference-examples)

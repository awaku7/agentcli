...
- **Поддержка нескольких провайдеров**: Поддерживает OpenAI / Azure / Bedrock / OpenRouter / Ollama / Gemini / Vertex AI / Claude / Grok / NVIDIA / DeepSeek / Alibaba Cloud (Qwen) / Moonshot AI / MiMo / LM Studio.
- **Гибкие интерфейсы**:
...
- `:skills`: выбрать и загрузить Agent Skills (используйте `:skills mp_search` для просмотра торговых площадок [SkillsMP](https://skillsmp.com) или [ClawHub](https://clawhub.ai))

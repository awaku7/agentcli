...
- **220 alat** untuk operasi fail, carian web, imej, audio, dokumen, IoT, MCP, A2A dan pembangunan.
...
- **128 alat** ditanda `x_parallel_safe` dan boleh dijalankan secara selari.

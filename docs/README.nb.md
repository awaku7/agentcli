...
- **Verktøykatalog (Ny!)**: Oppdag og last verktøy dynamisk med `tool_catalog`/`tool_load`. Fungerer med alle støttede leverandører — ingen leverandørspesifikke APIer kreves.

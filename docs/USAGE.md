...
| `UAGENT_CONSECUTIVE_TOOL_CALL_LIMIT` | Maximum consecutive LLM rounds with fresh tool calls, across tool names and arguments; parallel calls in one round count once (default: `50`) |

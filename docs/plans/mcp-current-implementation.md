...
| MCP Authorization / CIMD / issuer検証 | Metadata・issuer検証・PKCE・code/refresh exchange・暗号化Token Store・認可セッション・stateless/SDK HTTPのBearer付与/401 refresh・localhost callback listener・browser認可統合・CIMD取得/検証を実装 |

...
| MCP Authorization / CIMD / issuer検証 | Metadata・issuer検証・PKCE・code/refresh exchange・暗号化Token Store・認可セッション・stateless HTTPのBearer付与/401 refreshを実装。browser callback/CIMDは未実装 |

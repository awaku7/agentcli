...
| **Pronóstico** | Previsión de series temporales con 9 modelos (AutoARIMA, Prophet, LightGBM, CatBoost, TimesFM, etc.), selección automática de modelos, generación de gráficos, i18n |

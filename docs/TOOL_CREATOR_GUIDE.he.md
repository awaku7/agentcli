...
1. [מבנה הכלי הבסיסי](#1-%D7%91%D7%A1%D7%99%D7%A1-%D7%9B%D7%9C%D7%99-%D7%9E%D7%91%D7%A0%D7%94)

1. [יצירת כלי Python](#2-creating-a-python-tool)
...
1. [בדיקה וניפוי באגים](#6-testing-and-debugging)

1. [דוגמאות עזר](#7-reference-examples)

...
<h1align="center">uag — 通用人工智慧閘道</h1>
...
- **111 種工具**：檔案 I/O、網路搜尋、影像產生、BLE 裝置掃描、MCP 伺服器整合 — 並且 **其中 55 種工具並行運作**。當 LLM 一次觸發多個工具呼叫時，uag 會透過執行緒池自動執行它們。
...
OpenAI / Azure / Bedrock / OpenRouter / Ollama / Gemini / Vertex AI / Claude / Grok / NVIDIA / DeepSeek / 阿里雲 (Qwen) / KIMI (Moonshot AI) / 小米 MiMo / LM Studio MiMo / LM Studio MiMo / LM Studio MiMo

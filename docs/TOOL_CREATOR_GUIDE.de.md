...
1. \[Erstellen eines Python-Tools\](#2-Erstellen eines Python-Tools)

1. [Ein Rust + Python-Tool erstellen](#3-creating-a-rust--python-tool)

1. [TOOL_SPEC-Referenz](#4-tool_spec-reference)

1. [Internationalisierung (i18n)](#5-internationalisierung-i18n)

1. [Testen und Debuggen](#6-Testen-und-Debuggen)

1. [Referenzbeispiele](#7-reference-examples)

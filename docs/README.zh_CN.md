...
如果设置 `UAGENT_RESPONSES=1`，受支持的提供方将使用 Responses API：OpenAI / Azure / Bedrock / OpenRouter / Ollama。
Gemini / Claude / Vertex AI 使用各自的原生 API 路径，不在 Responses API 的覆盖范围内。
对于其他提供方，uag 会回退到提供方专用路径或 chat-completions 流程。

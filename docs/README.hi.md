...
| **डेव टूल्स** | workspace_status, git_ops, Python_compile, lint_format, run_tests, db_query, **29 स्रोत कोड नेविगेटर (idx परिवार)** |
...
- `workspace_status`: फ़ाइलों को संशोधित किए बिना सक्रिय कार्यक्षेत्र Git शाखा, परिवर्तन, अपस्ट्रीम सिंक स्थिति, Python रनटाइम और सामान्य प्रोजेक्ट मार्करों की रिपोर्ट करें।
...
## आर्किटेक्चर और परिचालन इनवेरिएंट

A2A जीवनचक्र, I18N संदर्भ, वैकल्पिक निर्भरता इंस्टॉलेशन, टूल सुरक्षा, प्रदाता क्षमताओं, OAuth विश्वास सीमाओं, संरचित इवेंट और स्वीकृति सत्यापन को कवर करने वाले स्थायी कार्यान्वयन अनुबंधों के लिए [ARCHITECTURE.md](ARCHITECTURE.md) देखें।

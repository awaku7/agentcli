...
ओपनएआई / PFN (PLaMo) / एज़्योर / बेडरॉक / ओपनराउटर / ओलामा / जेमिनी / वर्टेक्स एआई / क्लाउड / ग्रोक / एनवीडिया / नोविटा / डीपसीक / जेड.एआई (झिपू एआई) / हगिंगफेस / अलीबाबा क्लाउड (क्यूवेन) / किमी (मूनशॉट एआई) / श्याओमी मीमो / एलएम स्टूडियो / मिनीमैक्स / **सकाना एआई (फुगु)** / **SAKURA AI Engine** / **Together AI** / **Vercel AI Gateway**
...
| **डेव टूल्स** | git_ops, Python_compile, lint_format, run_tests, db_query, **26 स्रोत कोड नेविगेटर (idx परिवार)** |

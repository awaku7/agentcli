...
87 उपकरण `x_parallel_safe` के रूप में चिह्नित हैं और `ThreadPoolExecutor` के माध्यम से समवर्ती रूप से निष्पादित होते हैं (डिफ़ॉल्ट रूप से 8 थ्रेड; बदलने के लिए `UAGENT_PARALLEL_WORKERS` सेट करें)।

...
- **प्रदाता स्वतंत्रता**: ओपनएआई, क्लाउड, जेमिनी, डीपसीक, ओलामा, एज़्योर, बेडरॉक, हगिंगफेस... 21+ प्रदाता, सभी एक ही इंटरफ़ेस से पहुंच योग्य हैं। पर्यावरण चर को पुन: कॉन्फ़िगर करके उनके बीच स्वैप करें - कोई पुनर्स्थापना नहीं, कोई माइग्रेशन नहीं।
- **183 उपकरण**: फ़ाइल I/O, वेब खोज, छवि निर्माण, जीमेल, BLE डिवाइस स्कैनिंग, MCP सर्वर एकीकरण - **111 समानांतर-सुरक्षित हैं** (8 तक थ्रेड पूल के माध्यम से समवर्ती रूप से निष्पादित, `UAGENT_PARALLEL_WORKERS` के माध्यम से कॉन्फ़िगर करने योग्य)। जब एलएलएम एक साथ कई टूल कॉल सक्रिय करता है, तो यूएजी स्वचालित रूप से उन्हें समानांतर कर देता है।
...
ओपनएआई / एज़्योर / बेडरॉक / ओपनराउटर / ओलामा / जेमिनी / वर्टेक्स एआई / क्लाउड / ग्रोक / एनवीडिया / डीपसीक / जेड.एआई (झिपू एआई) / हगिंगफेस / अलीबाबा क्लाउड (क्यूवेन) / किमी (मूनशॉट एआई) / श्याओमी मीमो / एलएम स्टूडियो / मिनीमैक्स / **सकाना एआई (फुगु)** / **Together AI** / **Vercel AI Gateway**
...
111 उपकरण `x_parallel_safe` के रूप में चिह्नित हैं और `ThreadPoolExecutor` के माध्यम से समवर्ती रूप से निष्पादित होते हैं (डिफ़ॉल्ट रूप से 8 थ्रेड; बदलने के लिए `UAGENT_PARALLEL_WORKERS` सेट करें)।
...
- **BACnet**: BACnet/IP डिवाइस (HVAC, लाइटिंग, पावर मीटर) पढ़ें/लिखें। पुश नोटिफिकेशन के लिए COV सदस्यता
- **मोडबस टीसीपी**: होल्डिंग/इनपुट रजिस्टर और कॉइल पढ़ें/लिखें। मतदान-आधारित परिवर्तन निगरानी[=बीआर=]- **ओपीसी यूए**: पता स्थान ब्राउज़ करें, चर पढ़ें/लिखें, डेटा परिवर्तनों की सदस्यता लें[=बीआर=]- **स्विचबॉट**: क्लाउड बैच नियंत्रण और बीएलई स्कैन/नियंत्रण। मतदान-आधारित सदस्यता[=बीआर=]- **इकोनेट लाइट**: घरेलू उपकरणों (एसी, लाइट, वॉटर हीटर इत्यादि) से आईएनएफ अधिसूचनाओं को खोजें, नियंत्रित करें और सदस्यता लें। [IOT_USECASE.md](IOT_USECASE.md)

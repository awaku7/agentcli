...
- **131 כלים**: קלט/פלט קבצים, חיפוש באינטרנט, יצירת תמונות, סריקת מכשירי BLE, שילוב שרת MCP - ו-**76 מהם פועלים במקביל**. כאשר ה-LLM יורה מספר קריאות כלים בו-זמנית, uag מבצעת אותן אוטומטית באמצעות מאגר אשכולות.
- **4 ממשקי משתמש + A2A**: CLI, GUI, אינטרנט ופרוטוקול סוכן לסוכן. אותו מנוע, כל ממשק.
...
76 כלים מסומנים 'x_parallel_safe' ומופעלים במקביל באמצעות 'ThreadPoolExecutor' בעל 4 חוטים.
...
| **כלי פיתוח** | git_ops, python_compile, lint_format, run_tests, db_query, **13 כלי idx** |
...
| **ניווט קוד מקור** | **13 כלי idx** (Python, PHP, TypeScript, Java, C#, Dart, C/C++, Rust, Go, Swift, Kotlin, COBOL) — קבל אינדקס פונקציות/מחלקות או הגדרה ספציפית מבלי לקרוא את כל הקובץ |

### 🖥 3 ממשקים + A2A + VS Code

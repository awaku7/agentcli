...
- **Catálogo de ferramentas (Novo!)**: Descubra e carregue ferramentas dinamicamente com `tool_catalog`/`tool_load`. Funciona com todos os provedores suportados — nenhuma API específica do provedor necessária.

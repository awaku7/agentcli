...
1. [Cấu trúc công cụ cơ bản](#1-c%E1%BA%A5u-tr%C3%BAc-c%C3%B4ng-c%E1%BB%A5-c%C6%A1-b%E1%BA%A3n)

1. [Tạo công cụ Python](#2-creating-a-python-tool)

1. [Tạo công cụ Rust + Python](#3-creating-a-rust--python-tool)

1. [Tham khảo TOOL_SPEC](#4-tool_spec-reference)

1. [Quốc tế hóa (i18n)](#5-internationalization-i18n)

1. [Kiểm tra và gỡ lỗi](#6-ki%E1%BB%83m-tra-v%C3%A0-g%E1%BB%A1-l%E1%BB%97i)

1. [Ví dụ tham khảo](#7-reference-examples)

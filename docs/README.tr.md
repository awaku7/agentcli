...
<p align="center">
  ...
  ·
  <a href="README.translations.md">Kendi dilinizde okuyun</a>
</p>
...
Tüm ortam değişkenleri için [ENVIRONMENT.md](../ENVIRONMENT.md)) bölümüne bakın.
...
[IOT_USECASE.md](../IOT_USECASE.md)) bölümüne bakın.
...
Değiştirmek için `UAGENT_LANG` ayarını yapın. Yeni bir yerel ayar eklemek için [ADD_LOCALE.md](../src/uagent/docs/ADD_LOCALE.md)) bölümüne bakın.

Bu README'nin çevirileri [docs/README.translations.md](README.translations.md)) dosyasında mevcuttur.
...
- **Responses API**: Responses API modu için `UAGENT_RESPONSES=1` ayarlayın (OpenAI/Azure/Bedrock/OpenRouter/Ollama/Alibaba/LM Studio/Sakana AI)
- **Geliştirici dökümanları**: [DEVELOP.md](../src/uagent/docs/DEVELOP.md))

...
[DEVELOP_TOOL.md](../src/uagent/docs/DEVELOP_TOOL.md)를 참조하세요.
...
1. [기본 도구 구조](#1-%EA%B8%B0%EB%B3%B8-%EB%8F%84%EA%B5%AC-%EA%B5%AC%EC%A1%B0)

1. [Python 도구 만들기](#2-creating-a-python-tool)

1. [Rust + Python 도구 만들기](#3-creating-a-rust--python-tool)

1. [TOOL_SPEC 참조](#4-tool_spec-reference)

1. [국제화(i18n)](#5-%EA%B5%AD%EC%A0%9C%ED%99%94-i18n)

1. [테스트 및 디버깅](#6-%ED%85%8C%EC%8A%A4%ED%8A%B8-%EB%B0%8F-%EB%94%94%EB%B2%84%EA%B9%85)

1. [참조 예](#7-reference-examples)

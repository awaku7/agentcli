...
- **112 εργαλεία**: I/O αρχείων, αναζήτηση ιστού, δημιουργία εικόνων, σάρωση συσκευών BLE, ενσωμάτωση διακομιστή MCP — και **55 από αυτά εκτελούνται παράλληλα**. Όταν το LLM πραγματοποιεί πολλαπλές κλήσεις εργαλείων ταυτόχρονα, το uag τις εκτελεί αυτόματα μέσω μιας ομάδας νημάτων.

...
89 εργαλεία επισημαίνονται ως "x_parallel_safe" και εκτελούνται ταυτόχρονα μέσω ενός "ThreadPoolExecutor" (8 νήματα από προεπιλογή, ορίστε το "UAGENT_PARALLEL_WORKERS" για αλλαγή).
